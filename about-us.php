...
<div class="container01">
  <div style="text-align:center">
    ...
    <h2>Welcome To <span>CU Staff</span> Platform!</h2>
  </div>
  <div class="row01">
    <div class="column01">
      <img src="assets/img/logo/about.webp" style="width:100%">
    </div>
    <div class="column01">
      <h3>This Website will help you to find your subjects teachers or others experienced faculties for you particular problem or related to your Semester</h3>
            <p class="fst-italic">
              Our team countinuously working 24/7 to improve this site and collecting the details of faculties and semester related contents.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Website for the Students of Chandigarh University</li>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="fas fa-quote-left fa-3x fa-pull-left fa-border"></i>
                    WE FACED A LOT OF CHALLENGES , BUT FINALLY A GOOD THING HERE FOR YOU ALL.
                  </p>
                </div>
              </div>
            </div><!-- End testimonial item -->
