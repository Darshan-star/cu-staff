...
$arrType=array("Engineering Dept.","Non-Engineering Dept.");
?>
<div class="row">
			<h1 class="grid_title ml10 ml15">Faculties</h1>
                ...
                <div class="card-body">
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Faculty Name" name="dish" required value="<?php echo $dish?>">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail3" required>Faculty Detail</label>
                      <textarea name="dish_detail" class="form-control" placeholder="Faculty Detail"><?php echo $dish_detail?></textarea>
                    </div>
					<div class="form-group">
                      <label for="exampleInputEmail3">Faculty Image</label>
                      <input type="file" class="form-control" placeholder="Faculty Image" name="image" <?php echo $image_status?>>
					  <div class="error mt8"><?php echo $image_error?></div>
                    </div>
					<div class="form-group" id="dish_box1">
						 <label for="exampleInputEmail3">Faculty Attributes</label>
					<?php if($id==0){?>
						<div class="row">
							<!-- <div class="col-4">
